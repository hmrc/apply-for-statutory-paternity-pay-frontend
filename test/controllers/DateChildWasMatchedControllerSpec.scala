...
class DateChildWasMatchedControllerSpec extends SpecBase with MockitoSugar {
  ...
  def getRequest(): FakeRequest[AnyContentAsEmpty.type] =
    FakeRequest(GET, dateChildWasMatchedRoute)

  def postRequest(): FakeRequest[AnyContentAsFormUrlEncoded] =
    FakeRequest(POST, dateChildWasMatchedRoute)
  ...
  "DateChildWasMatched Controller" - {
    ...
    "must return OK and the correct view for a GET" in {
      ...
      running(application) {
        ...
        val view = application.injector.instanceOf[DateChildWasMatchedView]
    ...
    "must populate the view correctly on a GET when the question has previously been answered" in {
      ...
      val userAnswers = UserAnswers(userAnswersId).set(DateChildWasMatchedPage, validAnswer).success.value
