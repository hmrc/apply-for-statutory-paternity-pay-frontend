...
class ReasonForRequestingControllerSpec extends SpecBase with MockitoSugar {

  def onwardRoute = Call("GET", "/foo")

  lazy val reasonForRequestingRoute = routes.ReasonForRequestingController.onPageLoad(NormalMode).url
