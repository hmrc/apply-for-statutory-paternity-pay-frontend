...
class ReasonForRequestingSpec extends AnyFreeSpec with Matchers with ScalaCheckPropertyChecks with OptionValues {
    ...
    "must serialise" in {
      ...
      forAll(gen) {
        reasonForRequesting =>
          ...
          Json.toJson(reasonForRequesting) mustEqual JsString(reasonForRequesting.toString)
      }
    }
  }
}
