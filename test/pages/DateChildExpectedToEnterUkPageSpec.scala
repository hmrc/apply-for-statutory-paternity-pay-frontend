...
class DateChildExpectedToEnterUkPageSpec extends PageBehaviours with ScalaCheckPropertyChecks with Generators {

  "DateChildExpectedToEnterUkPage" - {

    beRetrievable[LocalDate](DateChildExpectedToEnterUkPage)

    beSettable[LocalDate](DateChildExpectedToEnterUkPage)

    beRemovable[LocalDate](DateChildExpectedToEnterUkPage)
