...
class DateChildEnteredUkPageSpec extends PageBehaviours with ScalaCheckPropertyChecks with Generators {

  "DateChildEnteredUkPage" - {

    beRetrievable[LocalDate](DateChildEnteredUkPage)

    beSettable[LocalDate](DateChildEnteredUkPage)

    beRemovable[LocalDate](DateChildEnteredUkPage)
