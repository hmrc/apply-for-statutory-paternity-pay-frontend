...
class WillHaveCaringResponsibilityPageSpec extends PageBehaviours {

  "WillHaveCaringResponsibilityPage" - {

    beRetrievable[Boolean](WillHaveCaringResponsibilityPage)

    beSettable[Boolean](WillHaveCaringResponsibilityPage)

    beRemovable[Boolean](WillHaveCaringResponsibilityPage)
    ...
    "must remove all subsequent answers when the answer is no" in {
      ...
      val result = answers.set(WillHaveCaringResponsibilityPage, false).success.value
      ...
      result.get(WillHaveCaringResponsibilityPage) must be(defined)
