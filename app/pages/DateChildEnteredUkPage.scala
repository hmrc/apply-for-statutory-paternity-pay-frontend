...
case object DateChildEnteredUkPage extends QuestionPage[LocalDate] {

  override def path: JsPath = JsPath \ toString

  override def toString: String = "dateChildEnteredUk"

  override def route(mode: Mode): Call = routes.DateChildEnteredUkController.onPageLoad(mode)
