...
class FopService @Inject()(
  ...
  private val userAgentBlock: FOUserAgent => Unit = { foUserAgent =>
    ...
    foUserAgent.setSubject("Ask your employer for Statutory Paternity Pay or Paternity Leave or both form")
    foUserAgent.setTitle("Ask your employer for Statutory Paternity Pay or Paternity Leave or both form")
  }
